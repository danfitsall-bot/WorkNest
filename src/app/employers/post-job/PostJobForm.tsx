...
export default function PostJobForm({ companyId, canFeature }: Props) {
  ...
  const [returnerFriendly, setReturnerFriendly] = useState(false)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
        ...
        <div>
          ...
          <input type="text" value={title} onChange={e => setTitle(e.target.value)} required
            ...
            placeholder="e.g. Senior Product Manager (Part-Time)" />
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <p className="text-gray-400 text-sm mb-4">Select all that apply — these drive search filters</p>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
        ...
        <div>
          ...
          <textarea value={description} onChange={e => setDescription(e.target.value)} required rows={8}
            ...
            placeholder="Describe the role, responsibilities, flexible working arrangements…" />
        </div>
        <div>
