    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <button
            onClick={() => signIn('google', { callbackUrl: role === 'EMPLOYER' ? '/employers/plans' : '/jobs' })}
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-2.5 px-4 font-medium text-gray-700 hover:bg-gray-50 transition-colors mb-6"
          >
